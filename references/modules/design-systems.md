...
---
# Design Systems - Visual Intelligence
...
```bash
python3 super-design-core/scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python3 super-design-core/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 super-design-core/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 super-design-core/scripts/search.py "<keyword>" --stack html-tailwind
```
...
```bash
python3 super-design-core/scripts/search.py "beauty spa wellness service elegant" --design-system -p "Serenity Spa"
```
...
python3 super-design-core/scripts/search.py "animation accessibility" --domain ux

# Get alternative typography options if needed
python3 super-design-core/scripts/search.py "elegant luxury serif" --domain typography
```

### Step 4: Stack Guidelines

```bash
python3 super-design-core/scripts/search.py "layout responsive form" --stack html-tailwind
```
...
python3 super-design-core/scripts/search.py "fintech crypto" --design-system

# Markdown - best for documentation
python3 super-design-core/scripts/search.py "fintech crypto" --design-system -f markdown
```
...
```bash
python3 super-design-core/scripts/search.py "<query>" --design-system --persist -p "Project Name"
```
...
```bash
python3 super-design-core/scripts/search.py "<query>" --design-system --persist -p "Project Name" --page "dashboard"
```
...
## Imported Module: Brand Guidelines Provider
---
...
## Imported Module: Core Components
---
...
## Imported Module: Radix Ui Design System
---
...
## Imported Module: Tailwind Design System
---
...
## Imported Module: Ui Ux Pro Max Skill Main
---
name: design-systems
description: "UI/UX design intelligence. 50 styles, 21 palettes, 50 font pairings, 20 charts, 9 stacks (React, Next.js, Vue, Svelte, SwiftUI, React Native, Flutter, Tailwind, shadcn/ui). Actions: plan, build, create, design, implement, review, fix, improve, optimize, enhance, refactor, check UI/UX code. Projects: website, landing page, dashboard, admin panel, e-commerce, SaaS, portfolio, blog, mobile app, .html, .tsx, .vue, .svelte. Elements: button, modal, navbar, sidebar, card, table, form, chart. Styles: glassmorphism, claymorphism, minimalism, brutalism, neumorphism, bento grid, dark mode, responsive, skeuomorphism, flat design. Topics: color palette, accessibility, animation, layout, typography, font pairing, spacing, hover, shadow, gradient. Integrations: shadcn/ui MCP for component search and examples."
---
