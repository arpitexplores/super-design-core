...
5. Rename the extracted folder from `super-design-core-main` to `super-design-core`.
6. Copy the renamed `super-design-core` folder into your agent's skills directory.
...
This repository is the `super-design-core` skill. Keep the full `super-design-core` folder together when installing it.
